...
const uint8_t PIN_MOVIMENTO = 34;
...
void loop()
{
  ...
  uint8_t entrada = digitalRead(PIN_MOVIMENTO);
  ...
  Serial.printf("\nADC: %8i Voltage: %8.2f Resistence: %8.2f Temperature: %8.2f \n", input_value2, voltage2, resistence2, temperature2); 
  ...
  json.set("/subsys_03/presence", presence_state);
